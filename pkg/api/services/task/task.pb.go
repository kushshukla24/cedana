...
var file_task_proto_rawDesc = []byte{
	...
	0x4a, 0x53, 0x4f, 0x4e, 0x22, 0x97, 0x01, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x75, 0x65, 0x4a, 0x6f,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x76,
	0x0a, 0x16, 0x51, 0x75, 0x65, 0x75, 0x65, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x74,
	...
	,
	...
	0x6e, 0x10, 0x07, 0x32, 0xd7, 0x13, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76,
	...
	0x75, 0x65, 0x75, 0x65, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x30, 0x5a,
	0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x65, 0x64, 0x61,
	0x6e, 0x61, 0x2f, 0x63, 0x65, 0x64, 0x61, 0x6e, 0x61, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70,
...
var file_task_proto_depIdxs = []int32{
	...
	47, // 8: cedana.services.task.DumpResp.State:type_name -> cedana.services.task.ProcessState
	8,  // 9: cedana.services.task.DumpResp.DumpStats:type_name -> cedana.services.task.DumpStats
	2,  // 10: cedana.services.task.RestoreArgs.Type:type_name -> cedana.services.task.CRType
	47, // 11: cedana.services.task.RestoreResp.State:type_name -> cedana.services.task.ProcessState
	10, // 12: cedana.services.task.RestoreResp.RestoreStats:type_name -> cedana.services.task.RestoreStats
	47, // 13: cedana.services.task.QueryResp.Processes:type_name -> cedana.services.task.ProcessState
	34, // 14: cedana.services.task.ContainerdDumpArgs.RuncDumpArgs:type_name -> cedana.services.task.RuncDumpArgs
	30, // 15: cedana.services.task.ContainerdDumpArgs.ContainerdRootfsDumpArgs:type_name -> cedana.services.task.ContainerdRootfsDumpArgs
	29, // 16: cedana.services.task.ContainerdQueryResp.Containers:type_name -> cedana.services.task.ContainerdContainer
	36, // 17: cedana.services.task.RuncDumpArgs.CriuOpts:type_name -> cedana.services.task.CriuOpts
	2,  // 18: cedana.services.task.RuncDumpArgs.Type:type_name -> cedana.services.task.CRType
	47, // 19: cedana.services.task.RuncDumpArgs.state:type_name -> cedana.services.task.ProcessState
	47, // 20: cedana.services.task.RuncDumpResp.State:type_name -> cedana.services.task.ProcessState
	39, // 21: cedana.services.task.RuncRestoreArgs.Opts:type_name -> cedana.services.task.RuncOpts
	2,  // 22: cedana.services.task.RuncRestoreArgs.Type:type_name -> cedana.services.task.CRType
	47, // 23: cedana.services.task.RuncRestoreResp.State:type_name -> cedana.services.task.ProcessState
	42, // 24: cedana.services.task.RuncQueryResp.Containers:type_name -> cedana.services.task.RuncContainer
	49, // 25: cedana.services.task.ProcessState.ProcessInfo:type_name -> cedana.services.task.ProcessInfo
	...
	48, // 28: cedana.services.task.ProcessState.RemoteState:type_name -> cedana.services.task.RemoteState
	50, // 29: cedana.services.task.ProcessState.HostInfo:type_name -> cedana.services.task.HostInfo
	51, // 30: cedana.services.task.ProcessState.CPUInfo:type_name -> cedana.services.task.CPUInfo
	52, // 31: cedana.services.task.ProcessState.MemoryInfo:type_name -> cedana.services.task.MemoryInfo
	53, // 32: cedana.services.task.ProcessInfo.OpenFds:type_name -> cedana.services.task.OpenFilesStat
	54, // 33: cedana.services.task.ProcessInfo.OpenConnections:type_name -> cedana.services.task.ConnectionStat
	6,  // 34: cedana.services.task.OpenFilesStat.Stream:type_name -> cedana.services.task.OpenFilesStat.StreamType
	55, // 35: cedana.services.task.ConnectionStat.Laddr:type_name -> cedana.services.task.Addr
	55, // 36: cedana.services.task.ConnectionStat.Raddr:type_name -> cedana.services.task.Addr
	7,  // 37: cedana.services.task.CheckpointReason.Reason:type_name -> cedana.services.task.CheckpointReason.CheckpointReasonEnum
	15, // 38: cedana.services.task.StartAttachArgs.Args:type_name -> cedana.services.task.StartArgs
	19, // 39: cedana.services.task.RestoreAttachArgs.Args:type_name -> cedana.services.task.RestoreArgs
	64, // 40: cedana.services.task.DetailedHealthCheckResponse.HealthCheckStats:type_name -> cedana.services.task.HealthCheckStats
	72, // 41: cedana.services.task.HealthCheckStats.GPUHealthCheck:type_name -> cedanagpu.HealthCheckResponse
	5,  // 42: cedana.services.task.QueueJobStatus.Status:type_name -> cedana.services.task.QueueJobStatusEnum
	15, // 43: cedana.services.task.TaskService.Start:input_type -> cedana.services.task.StartArgs
	17, // 44: cedana.services.task.TaskService.Dump:input_type -> cedana.services.task.DumpArgs
	19, // 45: cedana.services.task.TaskService.Restore:input_type -> cedana.services.task.RestoreArgs
	21, // 46: cedana.services.task.TaskService.Query:input_type -> cedana.services.task.QueryArgs
	23, // 47: cedana.services.task.TaskService.ContainerdDump:input_type -> cedana.services.task.ContainerdDumpArgs
	25, // 48: cedana.services.task.TaskService.ContainerdRestore:input_type -> cedana.services.task.ContainerdRestoreArgs
	27, // 49: cedana.services.task.TaskService.ContainerdQuery:input_type -> cedana.services.task.ContainerdQueryArgs
	30, // 50: cedana.services.task.TaskService.ContainerdRootfsDump:input_type -> cedana.services.task.ContainerdRootfsDumpArgs
	32, // 51: cedana.services.task.TaskService.ContainerdRootfsRestore:input_type -> cedana.services.task.ContainerdRootfsRestoreArgs
	34, // 52: cedana.services.task.TaskService.RuncDump:input_type -> cedana.services.task.RuncDumpArgs
	37, // 53: cedana.services.task.TaskService.RuncRestore:input_type -> cedana.services.task.RuncRestoreArgs
	40, // 54: cedana.services.task.TaskService.RuncQuery:input_type -> cedana.services.task.RuncQueryArgs
	43, // 55: cedana.services.task.TaskService.RuncGetPausePid:input_type -> cedana.services.task.RuncGetPausePidArgs
	13, // 56: cedana.services.task.TaskService.CRIORootfsDump:input_type -> cedana.services.task.CRIORootfsDumpArgs
	11, // 57: cedana.services.task.TaskService.CRIOImagePush:input_type -> cedana.services.task.CRIOImagePushArgs
	58, // 58: cedana.services.task.TaskService.StartAttach:input_type -> cedana.services.task.StartAttachArgs
	60, // 59: cedana.services.task.TaskService.RestoreAttach:input_type -> cedana.services.task.RestoreAttachArgs
	46, // 60: cedana.services.task.TaskService.LogStreaming:input_type -> cedana.services.task.LogStreamingResp
	56, // 61: cedana.services.task.TaskService.ProcessStateStreaming:input_type -> cedana.services.task.ProcessStateStreamingArgs
	62, // 62: cedana.services.task.TaskService.DetailedHealthCheck:input_type -> cedana.services.task.DetailedHealthCheckRequest
	17, // 63: cedana.services.task.TaskService.KataDump:input_type -> cedana.services.task.DumpArgs
	19, // 64: cedana.services.task.TaskService.KataRestore:input_type -> cedana.services.task.RestoreArgs
	65, // 65: cedana.services.task.TaskService.GetConfig:input_type -> cedana.services.task.GetConfigRequest
	67, // 66: cedana.services.task.TaskService.QueueCheckpoint:input_type -> cedana.services.task.QueueJobCheckpointRequest
	68, // 67: cedana.services.task.TaskService.QueueRestore:input_type -> cedana.services.task.QueueJobRestoreRequest
	69, // 68: cedana.services.task.TaskService.JobStatus:input_type -> cedana.services.task.QueueJobID
	16, // 69: cedana.services.task.TaskService.Start:output_type -> cedana.services.task.StartResp
	18, // 70: cedana.services.task.TaskService.Dump:output_type -> cedana.services.task.DumpResp
	20, // 71: cedana.services.task.TaskService.Restore:output_type -> cedana.services.task.RestoreResp
	22, // 72: cedana.services.task.TaskService.Query:output_type -> cedana.services.task.QueryResp
	24, // 73: cedana.services.task.TaskService.ContainerdDump:output_type -> cedana.services.task.ContainerdDumpResp
	26, // 74: cedana.services.task.TaskService.ContainerdRestore:output_type -> cedana.services.task.ContainerdRestoreResp
	28, // 75: cedana.services.task.TaskService.ContainerdQuery:output_type -> cedana.services.task.ContainerdQueryResp
	31, // 76: cedana.services.task.TaskService.ContainerdRootfsDump:output_type -> cedana.services.task.ContainerdRootfsDumpResp
	33, // 77: cedana.services.task.TaskService.ContainerdRootfsRestore:output_type -> cedana.services.task.ContainerdRootfsRestoreResp
	35, // 78: cedana.services.task.TaskService.RuncDump:output_type -> cedana.services.task.RuncDumpResp
	38, // 79: cedana.services.task.TaskService.RuncRestore:output_type -> cedana.services.task.RuncRestoreResp
	41, // 80: cedana.services.task.TaskService.RuncQuery:output_type -> cedana.services.task.RuncQueryResp
	44, // 81: cedana.services.task.TaskService.RuncGetPausePid:output_type -> cedana.services.task.RuncGetPausePidResp
	14, // 82: cedana.services.task.TaskService.CRIORootfsDump:output_type -> cedana.services.task.CRIORootfsDumpResp
	12, // 83: cedana.services.task.TaskService.CRIOImagePush:output_type -> cedana.services.task.CRIOImagePushResp
	59, // 84: cedana.services.task.TaskService.StartAttach:output_type -> cedana.services.task.StartAttachResp
	61, // 85: cedana.services.task.TaskService.RestoreAttach:output_type -> cedana.services.task.RestoreAttachResp
	45, // 86: cedana.services.task.TaskService.LogStreaming:output_type -> cedana.services.task.LogStreamingArgs
	47, // 87: cedana.services.task.TaskService.ProcessStateStreaming:output_type -> cedana.services.task.ProcessState
	63, // 88: cedana.services.task.TaskService.DetailedHealthCheck:output_type -> cedana.services.task.DetailedHealthCheckResponse
	18, // 89: cedana.services.task.TaskService.KataDump:output_type -> cedana.services.task.DumpResp
	20, // 90: cedana.services.task.TaskService.KataRestore:output_type -> cedana.services.task.RestoreResp
	66, // 91: cedana.services.task.TaskService.GetConfig:output_type -> cedana.services.task.GetConfigResponse
	73, // 92: cedana.services.task.TaskService.QueueCheckpoint:output_type -> google.protobuf.BoolValue
	73, // 93: cedana.services.task.TaskService.QueueRestore:output_type -> google.protobuf.BoolValue
	70, // 94: cedana.services.task.TaskService.JobStatus:output_type -> cedana.services.task.QueueJobStatus
